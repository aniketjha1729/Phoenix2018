...
<body>
	...
	<div class="top-bar_sub_w3layouts_agile">
		<h6>THINGS DO NOT HAPPEN,THEY ARE MADE TO HAPPEN <a href="contact.html">Contact Us </a></h6>
		<div class="search">
			...
			<div class="header-nav-agileits">
				...
				<nav class="navbar navbar-default">
					...
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.html">Phoneix</a></h1>
					</div>
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="top_nav">
								...
								<li class="dropdown">
									<a href="#" class="dropdown-toggle active" data-toggle="dropdown" data-hover="Pages" role="button" aria-haspopup="true" aria-expanded="false">Forums <span class="fa fa-angle-down"></span></a>
									<ul class="dropdown-menu">
										<li><a href="robonix.html">Robonix</a></li>
										<li><a href="java.html">Java</a></li>
										<li><a href="python.html">Python</a></li>
										<li><a href="webdevelopment.html">Web-Developent</a></li>
									</ul>
								</li>
				...
				<div class="modal-header">
					...
					<div class="signin-form profile">
						...
						<div class="login-m_page">
							...
							<p><a href="join.html"> Don't have an account?</a></p>
						</div>
						<div class="clearfix"></div>
					</div>
				</div>
	...
	<div class="banner_bottom">
		<div class="banner_bottom_in">
			<h3 class="headerw3">Start where you are,Use what you have,Do what you can!</h3>
	...
	<div class="what-wedo">
		<div class="container">
			<h3 class="headerw3 two">Robonix</h3>
			<div class="inner_sec_w3_agileinfo">
				<div class="wedo-main">
					...
					<div class="wedo-left">
						<h4 class="sub-hdng">Grow Your Skills With Us</h4>
	...
	<div class="services">
		<div class="container">
			<h3 class="headerw3">Activites and Forums</h3>
			<div class="inner_sec_w3_agileinfo">
				...
				<div class="col-md-4 grid_info_main">
					<div class="grid_info">
						<div class="icon_info">
							...
							<p>The most  impressive thing about  pullquotes is that people read them…</p>
						</div>
					</div>
					<div class="grid_info second">
						<div class="icon_info">
							...
							<h5>LENSIFIED</h5>
							<p>Photography is about capturing souls not Smiles..</p>
						</div>
					</div>
				</div>
				<div class="col-md-4 grid_info_main">
					<div class="grid_info">
						<div class="icon_info">
							...
							<h5>ROBONIX</h5>
							<p>At bottom, robotics is about us. It is the discipline emulating our lives of wondering how we work..</p>
						</div>
					</div>
					<div class="grid_info second">
						<div class="icon_info">
	...
	<div class="top_spl_courses">
		<div class="container">
			<h3 class="headerw3">What Do We Have</h3>
			<div class="inner_sec_w3_agileinfo">
	...
	<div class="contact-footer-w3layouts-agile">
		...
		<div class="bottom-social-agileits-w3ls">
			<div class="container">
				...
				<div class="col-md-4 social-icons-wthree">
					...
					<a class="facebook" href="https://www.facebook.com/nsec.phoenix/"><span class="fa fa-facebook"></span></a>
		...
		<div class="copy-w3-agileits">
			<h2 class="footer-logo"><a href="index.html">Phoenix </a></h2>
			<p>© 2018 Phoenix . All Rights Reserved | Design by <a href="#">Phoneix</a> </p>
			<div class="clearfix"></div>
		</div>
	</div>
	<!--/footer -->
