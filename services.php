...
<body>
			...
			<div class="header-nav-agileits">
				...
				<nav class="navbar navbar-default">
					...
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.php">Phoenix</a></h1>
					</div>
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="top_nav">
								...
								<li class="dropdown">
									<a href="#" class="dropdown-toggle active" data-toggle="dropdown" data-hover="Pages" role="button" aria-haspopup="true" aria-expanded="false">Subsidaries <span class="fa fa-angle-down"></span></a>
									<ul class="dropdown-menu">
										<li><a href="#">Robonix</a></li>
										<li><a href="#">Cybernix</a></li>
										<li><a href="#">Designoid</a></li>
										<li><a href="#">Xenith</a></li>
									</ul>
								</li>
								<li><a href="Events.php">Events</a></li>
								<li><a href="Contact.php">Contact</a></li>
								<li><a class="sign" href="#" data-toggle="modal" data-target="#myModal2">Login/SignUp</a></li>
							</ul>
						</nav>
					</div>
				</nav>
				...
				<div class="modal-header">
					...
					<div class="signin-form profile">
						...
						<div class="login-m_page_img">
							...
							<img src="assets/images/model.jpg" alt=" " class="img-responsive" />
	...
	<div class="banner_bottom">
		<div class="banner_bottom_in">
			<h3 class="headerw3">Take the world's best Events, online.</h3>
	...
	<div class="services">
		<div class="container">
			<h3 class="headerw3">Featured Events</h3>
			<div class="inner_sec_w3_agileinfo">
					...
					<div id="myCarousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner" role="listbox">
							<div class="item active">
								<div class="row">
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="assets/images/g1.jpg" alt="Image" style="max-width:100%;"></div>
										<h5>Business &amp; Management</h5>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="assets/images/g2.jpg" alt="Image" style="max-width:100%;"></div>
										<h5>Data Structures</h5>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="assets/images/g3.jpg" alt="Image" style="max-width:100%;"></div>
										<h5>Digital Marketing</h5>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="assets/images/g4.jpg" alt="Image" style="max-width:100%;"></div>
										<h5>Financial Analyst Course</h5>
									</div>
								</div>
							</div>
							<div class="item">
								<div class="row">
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="assets/images/g5.jpg" alt="Image" style="max-width:100%;"></div>
										<h5>Arts &amp; Media </h5>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="assets/images/g6.jpg" alt="Image" style="max-width:100%;"></div>
										<h5>Literature</h5>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="assets/images/g7.jpg" alt="Image" style="max-width:100%;"></div>
										<h5>Study Skills</h5>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="assets/images/g1.jpg" alt="Image" style="max-width:100%;"></div>
					...
					<div id="parentVerticalTab">
						...
						<div class="resp-tabs-container hor_1">
							<div class="text-info">
								...
								<img src="assets/images/banner1.jpg" alt=" " class="img-responsive" />
							...
							<div class="text-info">
								...
								<p class="sec">Consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat
									voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid
									ex ea commodi consequatur.</p>
								<img src="assets/images/banner3.jpg" alt=" " class="img-responsive" />
