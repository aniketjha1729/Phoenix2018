...
<body class="my">
			...
			<div class="header-nav-agileits">
				...
				<nav class="navbar navbar-default">
					...
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.html">Phoenix </a></h1>
					</div>
							...
							<ul class="top_nav">
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
										<li><a class="active" href="#">Robonix</a></li>
										<li><a class="active" href="#">Cybernix</a></li>
										<li><a class="active" href="#">Designoid</a></li>
										<li><a class="active" href="#">Xenith</a></li>
									</ul>
								</li>
								<li class="dropdown">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="Pages" role="button" aria-haspopup="true" aria-expanded="false">Events <span class="fa fa-angle-down"></span></a>
									<ul class="dropdown-menu">
										<li><a class="active" href="#">Avenir</a></li>
										<li><a class="active" href="#">Ahvaahan</a></li>
										<li><a class="active" href="#">Brainstromer</a></li>
									</ul>
								</li>
	...
	<div class="contact-footer-w3layouts-agile">
		...
		<div class="copy-w3-agileits">
			<h2 class="footer-logo"><a class="jk" href="index.html">Phoenix </h2>
			<p>© 2018 Phoenix . All Rights Reserved | Design by <a class="jk" href="http://w3layouts.com/">Phoenix</a> </p>
			<div class="clearfix"></div>
		</div>
	</div>
	<!--/footer -->
